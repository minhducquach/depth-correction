...
BASE_DIR = "/home/quachmd/Bureau/depth-correction/datasets/darknav/Circular"
...
class DarkNav(torch.utils.data.Dataset):
    def __init__(self, dir=BASE_DIR):
        self.color_paths = os.path.join(dir, 'rgb')
        self.depth_paths = os.path.join(dir, 'depth')

        search_pattern = os.path.join(self.color_paths, '*.png')
