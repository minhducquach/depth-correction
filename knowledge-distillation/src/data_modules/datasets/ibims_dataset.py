...
BASE_DIR = "/home/quachmd/Bureau/depth-correction/datasets/iBims-1"
...
class Ibims(torch.utils.data.Dataset):
    def __init__(self, dir=BASE_DIR):
        ...
        for color_path in self.color_files:
            depth_path = color_path.replace('rgb', 'ibims1_core_mat')
            depth_path = depth_path.replace('.png', '_processed.npy')
