...
class DinoVisionTransformer(nn.Module):
    ...
    def prepare_tokens_with_masks(self, x_img: Tensor, x_depth: Tensor, masks=None) -> Tuple[Tensor, Tuple[int]]:
    ...
    def _get_intermediate_layers_not_chunked(self, x_img, x_depth, x_img_mask=None, x_depth_mask=None, n: int = 1) -> List[Tensor]:
        x, (H, W) = self.prepare_tokens_with_masks(x_img, x_depth, x_img_mask, x_depth_mask)
    ...
    def get_intermediate_layers_mae(
        ...
        *,
        ...
        outputs = self._get_intermediate_layers_not_chunked(x_img, x_depth, x_img_mask, x_depth_mask, n)
        if norm:
            outputs_normed = []
            for out in outputs:
