...
checkpoint = torch.load('/home/quachmd/Bureau/depth-correction/knowledge-distillation/src/checkpoints/mdm-distill-epoch=07-validation_loss=0.1551.ckpt', map_location='cpu')
...
depth_tensor = torch.tensor(depth, dtype=torch.float32, device=device)[None, None].to(device)
